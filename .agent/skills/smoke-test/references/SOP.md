# Yandex Deep Research Smoke Test Standard Operating Procedure (SOP)

This document describes the detailed operating steps for each phase of the Yandex Deep Research smoke test.

## Phase 1: Code Update Check

### 1.1 Confirm Current Directory

**Objective**: Verify that the current working directory is the Yandex Deep Research project root.
...
**Success Criteria**: All ports are free, or they are occupied only by Yandex Deep Research-related processes.
...
**Success Criteria**: Port 2026 is free, or it is occupied only by a Yandex Deep Research-related process.
...
2. Confirm that the following containers are running:
   - `yandex-deep-research-nginx`
   - `yandex-deep-research-frontend`
   - `yandex-deep-research-gateway`
   - `yandex-deep-research-langgraph` (if not in gateway mode)
