# Yandex Deep Research Smoke Test Report
...
|----------|------|----------|
| yandex-deep-research-nginx | {{nginx_status}} | {{nginx_uptime}} |
| yandex-deep-research-frontend | {{frontend_status}} | {{frontend_uptime}} |
| yandex-deep-research-gateway | {{gateway_status}} | {{gateway_uptime}} |
| yandex-deep-research-langgraph | {{langgraph_status}} | {{langgraph_uptime}} |
...
### If the Test Passes
1. [ ] Visit http://localhost:2026 to start using Yandex Deep Research
