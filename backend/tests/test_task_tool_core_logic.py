...
task_tool_module = importlib.import_module("yandex_deep_research.tools.builtins.task_tool")
...
def test_task_tool_emits_running_and_completed_events(monkeypatch):
    ...
    monkeypatch.setattr("yandex_deep_research.tools.get_available_tools", get_available_tools)
