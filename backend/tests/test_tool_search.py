...
from yandex_deep_research.tools.builtins.tool_search import (
...
class TestToolSearchTool:
    def test_no_registry(self):
        from yandex_deep_research.tools.builtins.tool_search import tool_search
...
class TestDeferredToolsPromptSection:
    ...
    def _mock_app_config(self, monkeypatch):
        ...
        from yandex_deep_research.config.tool_search_config import ToolSearchConfig
