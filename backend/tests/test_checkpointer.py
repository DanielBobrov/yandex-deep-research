...
import yandex_deep_research.config.app_config as app_config_module
from yandex_deep_research.agents.checkpointer import get_checkpointer, reset_checkpointer
from yandex_deep_research.config.checkpointer_config import (
    CheckpointerConfig,
...
class TestAsyncCheckpointer:
    ...
    async def test_sqlite_creates_parent_dir_via_to_thread(self):
        ...
        from yandex_deep_research.agents.checkpointer.async_provider import make_checkpointer
...
# ---------------------------------------------------------------------------
# YandexDeepResearchClient falls back to config checkpointer
# ---------------------------------------------------------------------------


class TestClientCheckpointerFallback:
    def test_client_uses_config_checkpointer_when_none_provided(self):
        """YandexDeepResearchClient._ensure_agent falls back to get_checkpointer() when checkpointer=None."""
        from langgraph.checkpoint.memory import InMemorySaver
