...
def e2e_env(tmp_path, monkeypatch):
    ...
    from yandex_deep_research.agents.lead_agent.agent import _build_middlewares as _original_build_middlewares
...
class TestConfigManagement:
    ...
    def test_update_mcp_config_writes_and_invalidates(self, e2e_env, tmp_path, monkeypatch):
        ...
        from yandex_deep_research.config.extensions_config import reload_extensions_config
