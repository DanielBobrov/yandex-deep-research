...
import yandex_deep_research.community.jina_ai.jina_client as jina_client_module
from yandex_deep_research.community.jina_ai.jina_client import JinaClient
from yandex_deep_research.community.jina_ai.tools import web_fetch_tool
...
async def test_crawl_warns_once_when_api_key_missing(jina_client, monkeypatch, caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="yandex_deep_research.community.jina_ai.jina_client"):
        await jina_client.crawl("https://example.com")
        await jina_client.crawl("https://example.com")
...
async def test_web_fetch_tool_returns_error_on_crawl_failure(monkeypatch):
    ...
    monkeypatch.setattr("yandex_deep_research.community.jina_ai.tools.get_app_config", lambda: mock_config)
