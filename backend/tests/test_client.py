"""Tests for YandexDeepResearchClient."""
...
from yandex_deep_research.config.paths import Paths
...
class TestClientInit:
    ...
    def test_invalid_agent_name(self, mock_app_config):
        with patch("yandex_deep_research.client.get_app_config", return_value=mock_app_config):
            ...
            with pytest.raises(ValueError, match="Invalid agent name"):
                YandexDeepResearchClient(agent_name="../path/traversal")
...
class TestExtractText:
    def test_string(self):
        assert YandexDeepResearchClient._extract_text("hello") == "hello"
    ...
    def test_list_text_blocks(self):
        ...
        assert YandexDeepResearchClient._extract_text(content) == "first\nsecond"

    def test_list_plain_strings(self):
        assert YandexDeepResearchClient._extract_text(["a", "b"]) == "a\nb"

    def test_empty_list(self):
        assert YandexDeepResearchClient._extract_text([]) == ""

    def test_other_type(self):
        assert YandexDeepResearchClient._extract_text(42) == "42"
...
class TestMemoryManagement:
    ...
    def test_get_memory_config(self, client):
        config = MagicMock()
        config.enabled = True
        config.storage_path = ".yandex-deep-research/memory.json"
...
class TestGatewayConformance:
    """Validate that YandexDeepResearchClient return dicts conform to Gateway Pydantic response models.
    ...
    def test_get_memory_config(self, client):
        ...
        mem_cfg.storage_path = ".yandex-deep-research/memory.json"
...
class TestInstallSkillSecurity:
    ...
    def test_zip_bomb_rejected(self, client):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            from yandex_deep_research.skills import installer as _installer
...
class TestAtomicWriteJson:
    def test_temp_file_cleaned_on_serialization_failure(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with pytest.raises(TypeError):
                YandexDeepResearchClient._atomic_write_json(target, bad_data)
    ...
    def test_happy_path_writes_atomically(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            YandexDeepResearchClient._atomic_write_json(target, data)
...
class TestSerializeMessage:
    def test_system_message(self):
        ...
        result = YandexDeepResearchClient._serialize_message(msg)
