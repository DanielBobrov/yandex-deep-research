...
from yandex_deep_research.config.subagents_config import (
...
class TestRegistryGetSubagentConfig:
    ...
    def test_returns_none_for_unknown_agent(self):
        from yandex_deep_research.subagents.registry import get_subagent_config
    ...
    def test_builtin_config_object_is_not_mutated(self):
        ...
        from yandex_deep_research.subagents.builtins import BUILTIN_SUBAGENTS
        from yandex_deep_research.subagents.registry import get_subagent_config
...
class TestRegistryListSubagents:
    ...
    def test_lists_both_builtin_agents(self):
        from yandex_deep_research.subagents.registry import list_subagents
