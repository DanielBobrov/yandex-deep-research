...
from yandex_deep_research.agents.memory.updater import _strip_upload_mentions_from_memory
from yandex_deep_research.agents.middlewares.memory_middleware import _filter_messages_for_memory, detect_correction, detect_reinforcement
...
class TestFilterMessagesForMemory:
    ...
    def test_upload_with_real_question_preserves_question(self):
        ...
        msgs = [
            _human(combined),
            _ai("The file contains: Hello YandexDeepResearch."),
        ]
        result = _filter_messages_for_memory(msgs)
        ...
        assert result[1].content == "The file contains: Hello YandexDeepResearch."
