"""Live integration tests for YandexDeepResearchClient with real API.
...
def client():
    """Create a real YandexDeepResearchClient (no mocks)."""
    return YandexDeepResearchClient(thinking_enabled=False)
