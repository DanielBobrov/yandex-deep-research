...
class TestChannelManager:
    ...
    def test_each_topic_creates_new_thread(self):
        """Messages with distinct topic_ids should each create a new YandexDeepResearch thread."""
        from app.channels.manager import ChannelManager
    ...
    def test_same_topic_reuses_thread(self):
        """Messages with the same topic_id should reuse the same YandexDeepResearch thread."""
        from app.channels.manager import ChannelManager
