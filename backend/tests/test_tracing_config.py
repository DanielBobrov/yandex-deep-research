"""Tests for yandex_deep_research.config.tracing_config."""

from __future__ import annotations

import pytest

from yandex_deep_research.config import tracing_config as tracing_module
...
def test_defaults_when_project_not_set(monkeypatch):
    ...
    assert cfg.langsmith.project == "yandex-deep-research"
