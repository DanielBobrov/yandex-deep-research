...
- Implementation: `packages/harness/yandex-deep-research/agents/memory/prompt.py`
- Prompt assembly: `packages/harness/yandex-deep-research/agents/lead_agent/prompt.py`
