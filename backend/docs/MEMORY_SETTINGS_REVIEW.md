...
1. Start Yandex Deep Research locally using any working development setup you already use.
   ...
   If you already have Yandex Deep Research running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.yandex-deep-research/memory.json`
