# Contributing to Yandex Deep Research Backend

Thank you for your interest in contributing to Yandex Deep Research! This document provides guidelines and instructions for contributing to the backend codebase.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/yandex-deep-research.git
...
```python
import pytest
from yandex-deep-research.models.factory import create_chat_model
...
1. Create tool in `packages/harness/yandex-deep-research/tools/builtins/` or `packages/harness/yandex-deep-research/community/`:

```python
# packages/harness/yandex-deep-research/tools/builtins/my_tool.py
...
tools:
  - name: my_tool
    group: my_group
    use: yandex-deep-research.tools.builtins.my_tool:my_tool
```

### Adding New Middleware

1. Create middleware in `packages/harness/yandex-deep-research/agents/middlewares/`:

```python
# packages/harness/yandex-deep-research/agents/middlewares/my_middleware.py
...
2. Register in `packages/harness/yandex-deep-research/agents/lead_agent/agent.py`:
...
1. Update `packages/harness/yandex-deep-research/config/app_config.py` with new fields
...
Thank you for contributing to Yandex Deep Research!
