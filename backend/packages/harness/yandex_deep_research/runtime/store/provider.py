...
and the embedded :class:`~yandex_deep_research.client.YandexDeepResearchClient`.
...
Usage::
    ...
    from yandex_deep_research.runtime.store.provider import get_store, store_context
...
from yandex_deep_research.runtime.store._sqlite_utils import ensure_sqlite_parent_dir, resolve_sqlite_conn_str
...
def _sync_store_cm(config) -> Iterator[BaseStore]:
    ...
    :class:`~yandex_deep_research.config.checkpointer_config.CheckpointerConfig` instance —
...
def get_store() -> BaseStore:
    ...
    from yandex_deep_research.config.app_config import _app_config
    from yandex_deep_research.config.checkpointer_config import get_checkpointer_config
