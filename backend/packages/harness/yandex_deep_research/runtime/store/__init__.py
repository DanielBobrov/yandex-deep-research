"""Store provider for the YandexDeepResearch runtime.
...
Sync usage (CLI / YandexDeepResearchClient)::

    from yandex_deep_research.runtime.store import get_store, store_context
