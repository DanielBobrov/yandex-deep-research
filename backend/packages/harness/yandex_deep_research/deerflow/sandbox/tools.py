...
from yandex_deep_research.agents.thread_state import ThreadDataState, ThreadState
from yandex_deep_research.config import get_app_config
from yandex_deep_research.config.paths import VIRTUAL_PATH_PREFIX
from yandex_deep_research.sandbox.exceptions import (
    SandboxError,
    SandboxNotFoundError,
    SandboxRuntimeError,
)
from yandex_deep_research.sandbox.file_operation_lock import get_file_operation_lock
from yandex_deep_research.sandbox.sandbox import Sandbox
from yandex_deep_research.sandbox.sandbox_provider import get_sandbox_provider
from yandex_deep_research.sandbox.search import GrepMatch
from yandex_deep_research.sandbox.security import LOCAL_HOST_BASH_DISABLED_MESSAGE, is_host_bash_allowed
...
def _get_mcp_allowed_paths() -> list[str]:
    ...
    allowed_paths = []
    try:
        from yandex_deep_research.config.extensions_config import get_extensions_config
