...
from yandex_deep_research.config.agents_config import load_agent_soul
from yandex_deep_research.skills import load_skills
from yandex_deep_research.skills.types import Skill
from yandex_deep_research.subagents import get_available_subagent_names
...
def _get_memory_context(agent_name: str | None = None) -> str:
    ...
    """
    try:
        from yandex_deep_research.agents.memory import format_memory_for_injection, get_memory_data
...
def get_deferred_tools_prompt_section() -> str:
    ...
    """
    from yandex_deep_research.tools.builtins.tool_search import get_deferred_registry
