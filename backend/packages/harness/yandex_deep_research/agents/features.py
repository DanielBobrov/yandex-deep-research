"""Declarative feature flags and middleware positioning for create_yandex_deep_research_agent.
...
class RuntimeFeatures:
    """Declarative feature flags for ``create_yandex_deep_research_agent``.
