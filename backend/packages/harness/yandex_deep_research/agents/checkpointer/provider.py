...
Usage::
    ...
    from yandex_deep_research.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from yandex_deep_research.config.checkpointer_config import CheckpointerConfig
from yandex_deep_research.runtime.store._sqlite_utils import resolve_sqlite_conn_str
