# Copilot Onboarding Instructions for Yandex Deep Research
...
Yandex Deep Research is a full-stack "super agent harness".
...
- `backend/packages/harness/yandex-deep-research/agents/` - lead agent, middleware chain, memory
- `backend/app/gateway/` - FastAPI gateway API
- `backend/packages/harness/yandex-deep-research/sandbox/` - sandbox provider + tool wrappers
- `backend/packages/harness/yandex-deep-research/subagents/` - subagent registry/execution
- `backend/packages/harness/yandex-deep-research/mcp/` - MCP integration
- `backend/langgraph.json` - graph entrypoint (`yandex-deep-research.agents:make_lead_agent`)
