# Contributing to Yandex Deep Research

Thank you for your interest in contributing to Yandex Deep Research! This guide will help you set up your development environment and understand our development workflow.
...
|---------|-----------|------------|-------|
| `make dev` on one machine | 4 vCPU, 8 GB RAM | 8 vCPU, 16 GB RAM | Best when Yandex Deep Research uses hosted model APIs. |
...
`2 vCPU / 4 GB` environments often fail to start reliably or become unresponsive under normal Yandex Deep Research workloads.
...
```text
unable to get image 'yandex-deep-research-dev-langgraph': permission denied while trying to connect to the Docker daemon socket at unix:///var/run/docker.sock
```
...
4. Verify Docker access:
   ...
   docker ps
   ```
5. Retry the Yandex Deep Research command:
   ```bash
   make docker-stop
   make docker-start
   ```
...
Host Machine
  ↓
Docker Compose (yandex-deep-research-dev)
...
- Check existing [Issues](https://github.com/yandex/yandex-deep-research/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/yandex/yandex-deep-research/discussions)

## License

By contributing to Yandex Deep Research, you agree that your contributions will be licensed under the [MIT License](./LICENSE).
